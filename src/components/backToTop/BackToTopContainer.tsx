...
const BackToTopContainer = () => {
  ...
  return (
    <div className="fixed z-50 right-4 bottom-25 sm:bottom-16 bg-orange-500 rounded-full p-3 flex items-center justify-center transition-all duration-500 animate-slide-up shadow-xl">
